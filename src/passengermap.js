...
export default function PassengerMap({ passengerEmail, pickupLocation, dropoffLocation, rideBooked, rideId, driverId, onLocationUpdate }) {
  ...
  useEffect(() => {
    if (passengerLocation && onLocationUpdate) {
      onLocationUpdate(passengerLocation);
    }
  }, [passengerLocation, onLocationUpdate]);
    ...
    <Paper elevation={3} sx={{ p: 2 }}>
      ...
      <Box sx={{ position: 'relative', height: 400 }}>
        <GoogleMap
          ...
          center={passengerLocation || { lat: 0, lng: 0 }}
          zoom={14}
          options={{
      ...
      <Box sx={{ mt: 2 }}>
        ...
        <Box sx={{ mt: 2, p: 1, bgcolor: "action.hover", borderRadius: 1 }}>
          <Typography variant="body2">
            <strong>Passenger Location:</strong> {passengerLocation ? "Active" : "Unknown"}
          </Typography>
          <Typography variant="body2">
            <strong>Driver Location:</strong> {driverLocation ? "Connected" : "Searching"}
          </Typography>
          <Typography variant="body2">
